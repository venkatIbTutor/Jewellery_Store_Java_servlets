        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <%
                try {
                    ...
                    String query = "select count(*) from jewellery";
                    ResultSet rs = st.executeQuery(query);
                    while (rs.next()) {
                        int jewel = rs.getInt(1);
            %>
            <div class="col-xl-3 col-lg-6" style="margin-top: 20px;">
                <div class="card card-inverse card-danger">
                    <div class="card-block bg-danger">
                        ...
                        <h6 class="text-uppercase" style="text-align: center"><a href="adminJewelleryList.jsp">Jewellery</a></h6>
                        <h1 class="display-1" style="text-align: center"><%= jewel%></h1>
                    </div>
                </div>
            </div>
            <%
            ...
            <div class="col-xl-3 col-lg-6" style="margin-top: 20px;">
                <div class="card card-inverse card-warning">
                    <div class="card-block bg-warning">
                        ...
                        <h6 class="text-uppercase" style="text-align: center"><a href="adminWorkerList.jsp">Workers</a></h6>

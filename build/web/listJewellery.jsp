                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="listJewellery.jsp">Jewelery List</a>
                        </div>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="table100 ver3 m-b-110">
                        ...
                        <%
                            try {
                                ...
                                if (query != null) {
                                    sql = "select * from jewellery where productName like '%" + query + "%' or type like '%" + query + "%' ";
                                } else {
                                    ...
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column7"><%=rs.getString(7)%></td>
                                         <td class="cell100 column8">
                                            <a href="updateJewellery.jsp?id=<%=productCode%>">Edit</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="deleteJewellery.jsp?id=<%=productCode%>">Delete</a>                     
                                        </td>
                                    </tr>
                                </tbody>
                                <%
